...
<p align="center">
  ...
  <img alt="Version"              src="https://img.shields.io/badge/version-2.0.2-ADEBB3?style=for-the-badge">
...
Download `mergen-2.0.2-1-x86_64.pkg.tar.zst` from the Releases page:

```sh
sudo pacman -U mergen-2.0.2-1-x86_64.pkg.tar.zst
```
